/**
 * @description Jdbc + Spring Xml配置方式实现事务管理
 */
...
public class JdbcTransitionTest {
	...
	{
		applicationContext = new ClassPathXmlApplicationContext("com/spring/conf/applicationContext_Jdbc.xml");
